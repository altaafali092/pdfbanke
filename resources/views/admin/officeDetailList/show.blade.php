...
@section('content')
    <div class="content-fluid">
        ...
        <div class="page-heading">
            <h1 class="page-title">Office Detail</h1>
            <nav style="--bs-breadcrumb-divider: '/';" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item" style="color: blue"><a href="{{ route('admin.dashboard') }}">ड्यासबोर्ड
                        </a></li>
                    <li class="breadcrumb-item" style="color: rgb(225, 237, 116)"><a
                            href="{{ route('admin.officeDetailList.index') }}"></a>हाम्रो बरेमा
                        </a></li>
                </ol>
            </nav>
        </div>
            ...
            <div class="col-md-12">
                <div class="ibox">
                    <div class="ibox-body">
                        <div class="col-md-12">
                            <div class="row">
                                @foreach ($officeDetailList->files as $file)
